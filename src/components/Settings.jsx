...
const Settings = ({ user, handleLogout, onResetProgress }) => {
  ...
  // Carregar preferências salvas e aplicar modo escuro IMEDIATAMENTE
  ...
  // Aplicar modo escuro IMEDIATAMENTE baseado no localStorage
  // Só aplicar se o usuário estiver logado
  if (user && savedDarkMode) {
  ...
  // Aplicar modo escuro quando o estado muda
  useEffect(() => {
    if (darkMode) {
      document.documentElement.classList.add('dark');
    } else {
  ...
  return (
    <div 
      ...
      role="main" 
      aria-label="Tela de Configurações"
    >
      <h1 
        className="text-4xl font-yufin text-primary mb-8 animate-fadeIn" 
        style={darkMode ? { color: '#fb923c' } : {}}
        aria-label="Título das Configurações"
      >
        Configurações ⚙️
      </h1>
      ...
      >
        <h2 
          ...
          aria-label="Subtítulo das Configurações"
        >
          Ajustes
        </h2>
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <span 
                  ...
                  style={darkMode ? { color: '#e5e7eb' } : {}}
                >
                  Lembretes diários e conquistas
                </span>
              </div>
            </div>
            <button
          ...
          {isAdmin && (
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  <label 
                    className="block font-semibold text-red-800" 
                    style={darkMode ? { color: '#fca5a5' } : {}}
                    aria-label="Modo Dev"
                  >
                    Modo Dev
                  </label>
          ...
          <div className="border-t pt-4">
            <h3 className="font-semibold text-gray-800 dark:text-white mb-3">Informações da Conta</h3>
