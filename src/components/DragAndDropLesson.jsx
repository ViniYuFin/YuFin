            ...
            {(lesson.content?.zones || lesson.content?.dropZones) ? (
              ...
              (lesson.content.zones || lesson.content.dropZones).map((zone, zoneIndex) => (
                <div
                  ...
                  style={{
                    backgroundColor: items.find(item => item.isPlaced && item.zone === zone.id) 
              ...
              lesson.content.categories.map((category, categoryIndex) => (
                <div
                  ...
                  style={{
                    backgroundColor: items.find(item => item.isPlaced && item.zone === category.id) 
                      ? (darkMode ? '#064e3b' : '#f0fdf4')
                      : (darkMode ? '#374151' : '#ffffff'),
                    color: darkMode ? '#ffffff' : '#1f2937',
                  ...
                  {(() => {
                    ...
                    if (placedItems.length > 0) {
                      return (
                        <div className="space-y-2 font-sans">
                          <p 
                            className="font-bold font-sans text-center mb-2"
                            style={{ color: darkMode ? '#ffffff' : '#1f2937' }}
                          >
                            {category.name}
                          </p>
                      ...
                      return (
                        <div className="text-center font-sans">
                          <p 
                            className="font-bold font-sans mb-2"
                            style={{ color: darkMode ? '#ffffff' : '#1f2937' }}
                          >
                            {category.name}
                          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 max-w-6xl mx-auto">
            {items.filter(item => !item.isPlaced).map((item, index) => (
              <div
                ...
                className="p-4 border-2 border-gray-300 rounded-xl shadow-md cursor-move hover:shadow-lg hover:border-blue-400 transition-all duration-200 font-sans h-20 flex items-center justify-center"
                style={{
                  backgroundColor: darkMode ? '#374151' : '#ffffff',
                  color: darkMode ? '#ffffff' : '#1f2937'
                }}
              >
                <p className="font-medium text-center font-sans text-sm leading-tight">{item.text}</p>
              </div>
            ))}
          </div>
        </div>
