          ...
          <div className="animate-fadeIn">
            {(() => {
              ...
              return Object.entries(groups).map(([groupKey, group]) => {
                ...
                return (
                  <div key={groupKey} className={`p-6 rounded-xl border-2 ${groupColor} transition-all duration-300 hover:shadow-lg`}>
                    {/* Header do Grupo */}
                    <div className="flex items-center justify-between mb-6">
                      <div className="flex items-center">
                        <span className="text-3xl mr-4">{group.icon}</span>
                        <div>
                          <h3 className="text-xl font-bold text-gray-800">{group.label}</h3>
                    ...
                    <div className="space-y-4">
                      {group.categories.map((category, index) => (
                        <div key={index} className={`flex items-center justify-between p-4 bg-white rounded-lg border transition-colors ${
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <input
                              ...
                              placeholder="1"
                            />
                            <span className="text-gray-700 font-medium">,00</span>
                          </div>
                        </div>
                      ))}
                    </div>
