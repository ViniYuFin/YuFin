            ...
            <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center">
              <span className="text-lg">👤</span>
                ...
                <div className="flex items-center space-x-2">
                  <span className="text-xs text-gray-500">Nível {user.progress?.level || 1}</span>
            ...
            <div className="bg-gradient-to-r from-yellow-100 to-orange-100 rounded-lg px-4 py-2 border-2 border-yellow-300 shadow-sm">
              <div className="flex items-center space-x-2">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-gray-600">YüCoins</div>
                </div>
              </div>
            </div>
        ...
        <div className="flex space-x-3 mb-8 overflow-x-auto">
          {[1, 2, 3, 4].map(moduleNum => {
            ...
            return (
              ...
              >
                <div className="text-center">
                  <div className="text-lg font-bold">Módulo {moduleNum}</div>
          ...
          >
            <div className="p-6 text-white">
              <div className="text-center mb-4">
                ...
                <h4 className="font-bold text-lg mb-2">{achievementCard.title}</h4>
                <p className="text-purple-100 text-sm mb-4">{achievementCard.description}</p>
              </div>
              
              <div className="bg-white bg-opacity-20 rounded-lg p-3 mb-4">
                <div className="text-center">
                  <div className="text-sm text-purple-600 font-semibold">Recompensa</div>
                  <div className="font-bold text-purple-900 !important" style={{color: '#581c87'}}>{achievementCard.reward}</div>
                </div>
              </div>
              ...
              <div className="text-center">
                {isModuleCompleted ? (
                  ...
                  <div className="text-center">
                    <div className="text-sm text-purple-100 mb-2">Progresso</div>
