...
const IntelligentDashboard = ({ user, setUser, setActiveScreen }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-interface">
      {/* Header Inteligente */}
      <div className="bg-white rounded-b-xl shadow-md sticky top-0 z-20 w-full" style={{ borderBottom: '3px solid #EE9116' }}>
      ...
      <div className="flex-grow overflow-y-auto p-3 pb-32 hide-scrollbar">
        ...
        <div className="bg-white rounded-xl shadow-md p-4 border-2 mb-4 overflow-hidden" style={{ borderColor: 'rgb(238, 145, 22)' }}>
        ...
        {userProfile && (
          <div className="bg-white rounded-xl shadow-md p-4 border-2 mb-4" style={{ borderColor: 'rgb(238, 145, 22)' }}>
            <h2 className="text-lg font-semibold text-gray-800 mb-3">📊 Seu Perfil de Aprendizado</h2>
            
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-3 bg-blue-50 rounded-lg">
                <div className="text-2xl mb-1">🎯</div>
                <div className="text-sm font-semibold text-gray-800">Estilo</div>
                <div className="text-xs text-gray-600 capitalize">{userProfile.learningStyle}</div>
              </div>
              
              <div className="text-center p-3 bg-green-50 rounded-lg">
                <div className="text-2xl mb-1">⚡</div>
                <div className="text-sm font-semibold text-gray-800">Dificuldade</div>
                <div className="text-xs text-gray-600 capitalize">{userProfile.difficultyPreference}</div>
              </div>
              
              <div className="text-center p-3 bg-yellow-50 rounded-lg">
                <div className="text-2xl mb-1">🕐</div>
                <div className="text-sm font-semibold text-gray-800">Horário Ideal</div>
                <div className="text-xs text-gray-600">{userProfile.optimalStudyTime}h</div>
              </div>
              
              <div className="text-center p-3 bg-purple-50 rounded-lg">
                <div className="text-2xl mb-1">💪</div>
                <div className="text-sm font-semibold text-gray-800">Motivação</div>
                <div className="text-xs text-gray-600">{userProfile.motivationFactors.length} fatores</div>
              </div>
            </div>
          </div>
        )}
