...
const lessonSchema = new mongoose.Schema({
  ...
  type: { 
    type: String, 
    required: true, 
    enum: ['drag-drop', 'quiz', 'choices', 'classify', 'match', 'simulation', 'input', 'budget-choices', 'categories-simulation', 'math-problems', 'shopping-simulation', 'price-comparison', 'budget-distribution'] 
  },
